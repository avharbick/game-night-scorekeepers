...
export default function FarkleGame({ onExit }: GameModuleProps) {
  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        <button className="brand" onClick={onExit} aria-label="Return to all games">
      ...
      {screen === "home" && <section className="home-view page-enter">
        <button className="module-back" onClick={onExit}>← All games</button>
